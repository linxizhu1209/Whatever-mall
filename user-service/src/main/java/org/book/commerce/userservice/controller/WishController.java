...
public class WishController {
    ...
    public ResponseEntity addWish(@RequestHeader("X-Authorization-Id") String userEmail, @PathVariable Long productId){
    ...
    public ResponseEntity deleteWish(@PathVariable Long productId,@RequestHeader("X-Authorization-Id") String userEmail){
